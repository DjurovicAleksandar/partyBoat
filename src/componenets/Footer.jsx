    ...
    <div>
      <footer className="text-gray-100">
        <div className="bg-gray-800/70">
          <div className="container flex flex-col justify-between items-center w-[90%] py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
            ...
            <div className="w-full md:flex justify-around ">
              <div className="space-y-3 text-center lg:text-left mb-4 md:mb-0">
              ...
              <div className="space-y-3 flex flex-col items-center ">
                ...
                <div className="flex justify-start space-x-3">
                  <a
                    rel="noopener noreferrer"
                    href="https://www.facebook.com/Balunzalogajnica"
                    target="_blank"
                    title="Facebook"
                  ...
                  <a
                    rel="noopener noreferrer"
                    href="https://www.instagram.com/party_boat_dubrovnik/"
                    target="_blank"
                    title="Instagram"
                    className="flex items-center p-1"
                  >
