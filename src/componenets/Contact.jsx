        ...
        <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
          <div className="aspect-square lg:bg-blue-400/60 lg:hover:bg-blue-900 rounded-full flex flex-col items-center justify-center mr-4 p-4">
            ...
            <div className="space-y-4 text-lg">
              <a
                href="https://goo.gl/maps/CbdQWnXEbHZ1qUWG7"
                target="_blank"
              ...
              >
                ...
                <span>Sudjuradj 14, Šipan, 20000 Dubrovnik</span>
              </a>
              <a href="tel:+385989004143" className="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                ...
                <span>+385989004143</span>
              </a>
              <a
                href="mailto:partyboatdubrovnik@outlook.com"
                className="flex items-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span>partyboatdubrovnik@outlook.com</span>
              </a>
              <a
                href="https://wa.me/385989004143"
                target="_blank"
                className="flex items-center"
              >
                <svg
              ...
              <a
                href="viber://chat?number=385989004143"
                target="_blank"
                className="flex items-center"
              >
                <svg
                ...
                <span>Send us a message on Viber</span>
              </a>
            </div>
          </div>
          <form
            action="https://formsubmit.com/partyboatdubrovnik@outlook.com"
            method="POST"
